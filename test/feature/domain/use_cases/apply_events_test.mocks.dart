...
import 'apply_events_test.dart' as _i9;
...
class MockEventRepository extends _i1.Mock implements _i3.EventRepository {
  ...
  _i4.Future<_i2.Either<_i5.Failure, void>> fetch(
    ...
    String? authToken,
      ...
      (super.noSuchMethod(
            Invocation.method(#fetch, [host, pool], {#authToken: authToken}),
  ...
  _i4.Future<_i2.Either<_i5.Failure, void>> push(
    ...
    String? authToken,
      ...
      (super.noSuchMethod(
            Invocation.method(#push, [host, pool], {#authToken: authToken}),
            returnValue: _i4.Future<_i2.Either<_i5.Failure, void>>.value(
              _FakeEither_0<_i5.Failure, void>(
                this,
                Invocation.method(#push, [host, pool], {#authToken: authToken}),
  ...
  _i4.Future<_i2.Either<_i5.Failure, void>> add(
    ...
    int? pool,
      ...
      (super.noSuchMethod(
            Invocation.method(#add, [event, pool]),
            returnValue: _i4.Future<_i2.Either<_i5.Failure, void>>.value(
              _FakeEither_0<_i5.Failure, void>(
                this,
                Invocation.method(#add, [event, pool]),
  ...
  _i4.Future<_i2.Either<_i5.Failure, void>> markApplied(_i8.EventStub? event) =>
      (super.noSuchMethod(
            Invocation.method(#markApplied, [event]),
            returnValue: _i4.Future<_i2.Either<_i5.Failure, void>>.value(
              _FakeEither_0<_i5.Failure, void>(
                this,
                Invocation.method(#markApplied, [event]),
  ...
  _i4.Future<_i2.Either<_i5.Failure, void>> markAppliedList(
    List<_i8.EventStub>? events,
      ...
      (super.noSuchMethod(
            Invocation.method(#markAppliedList, [events]),
            returnValue: _i4.Future<_i2.Either<_i5.Failure, void>>.value(
              _FakeEither_0<_i5.Failure, void>(
                this,
                Invocation.method(#markAppliedList, [events]),
  ...
  _i4.Future<_i2.Either<_i5.Failure, void>> clearPoolCache(int? pool) =>
      (super.noSuchMethod(
            Invocation.method(#clearPoolCache, [pool]),
            returnValue: _i4.Future<_i2.Either<_i5.Failure, void>>.value(
              _FakeEither_0<_i5.Failure, void>(
                this,
                Invocation.method(#clearPoolCache, [pool]),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTestEventHandler extends _i1.Mock implements _i9.TestEventHandler {
  MockTestEventHandler() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<void> call(String? streamId, int? pool, _i9.TestEventData? data) =>
      (super.noSuchMethod(
            Invocation.method(#call, [streamId, pool, data]),

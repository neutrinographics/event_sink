...
void main() {
  ...
  setUp(() {
    ...
    tParams = SyncEventsParams(
      pool: tPool,
      dataSource: mockEventRemoteDataSource,
    );
  });
  ...
  test(
    ...
    () async {
      // arrange
      when(mockEventRepository.fetch(mockEventRemoteDataSource, tPool))
          .thenAnswer((_) async => const Right(null));
      when(mockEventRepository.rebase(tPool))
          .thenAnswer((_) async => const Right(null));
      when(mockEventRepository.push(mockEventRemoteDataSource, tPool))
          .thenAnswer((_) async => const Right(null));
      // act
      final result = await useCase(tParams);
      // assert
      expect(result, const Right(null));
      verify(mockEventRepository.push(mockEventRemoteDataSource, tPool));
    },
  );
  ...
  test(
    ...
    () async {
      ...
      verify(mockEventRepository.fetch(mockEventRemoteDataSource, tPool));

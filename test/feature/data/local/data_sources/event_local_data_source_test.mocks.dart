...
class MockCleanCache<K, T> extends _i1.Mock implements _i3.CleanCache<K, T> {
  @override
  _i2.Future<void> write(K? key, T? data) =>
      (super.noSuchMethod(
            Invocation.method(#write, [key, data]),
  ...
  @override
  _i2.Future<void> writeAll(Map<K, T>? data) =>
      (super.noSuchMethod(
            Invocation.method(#writeAll, [data]),
            returnValue: _i2.Future<void>.value(),
            returnValueForMissingStub: _i2.Future<void>.value(),
          )
          as _i2.Future<void>);
  ...
  _i2.Future<T> read(K? key) =>
      (super.noSuchMethod(
            ...
            returnValue:
                ...
                _FakeFuture_0<T>(this, Invocation.method(#read, [key])),
  ...
  @override
  _i2.Future<List<K>> keys() =>
      (super.noSuchMethod(
            Invocation.method(#keys, []),
